...
public class GridDebug : MonoBehaviour
{
    ...
    private void DisplayCell(Cell cell)
    {
        ...
        iconGO.transform.position = cell.worldPos + Vector3.back * 0.1f;
        ...
        iconGO.transform.rotation = Quaternion.Euler(0, 0, zRot);
    }
    ...
    private void OnDrawGizmos()
    {
        ...
        switch (curDisplayType)
        {
            case FlowFieldDisplayType.CostField:
                foreach (Cell curCell in curFlowField.grid)
                {
                    Handles.Label(curCell.worldPos + Vector3.up * 0.1f, curCell.cost.ToString(), style);
                }
                break;
            ...
            case FlowFieldDisplayType.IntegrationField:
                foreach (Cell curCell in curFlowField.grid)
                {
                    Handles.Label(curCell.worldPos + Vector3.up * 0.1f, curCell.bestCost.ToString(), style);
                }
                break;
        }
#endif
