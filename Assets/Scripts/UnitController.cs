...
public class UnitController : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        {
            Cell cellBelow = gridController.currentFlowField.GetCellFromWorldPos(unit.transform.position);
    ...
    private void SpawnUnits()
    {
        ...
        for (int i = 0; i < numUnitsPerSpawn; i++)
        {
            ...
            do
            {
                newPos = new Vector3(Random.Range(0, maxSpawnPos.x), Random.Range(0, maxSpawnPos.y), 0f);
